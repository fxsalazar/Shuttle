 ...
 */
public class NavigationControllerImpl extends BaseNavigationController {
     ...
     */
    public static NavigationControllerImpl newInstance(FragmentInfo fragmentInfo) {
        Bundle args = new Bundle();
        args.putParcelable(ARG_FRAGMENT_INFO, fragmentInfo);
        NavigationControllerImpl fragment = new NavigationControllerImpl();
